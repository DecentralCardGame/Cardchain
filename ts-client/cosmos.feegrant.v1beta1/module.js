...
exports.queryClient = exports.txClient = exports.registry = exports.MsgGrantAllowance = exports.MsgRevokeAllowance = void 0;
...
Object.defineProperty(exports, "MsgGrantAllowance", { enumerable: true, get: function () { return tx_2.MsgGrantAllowance; } });
    ...
    return {
        ...
        async sendMsgGrantAllowance({ value, fee, memo }) {
            ...
            try {
                const { address } = (await signer.getAccounts())[0];
                const signingClient = await stargate_1.SigningStargateClient.connectWithSigner(addr, signer, { registry: exports.registry, prefix });
                let msg = this.msgGrantAllowance({ value: tx_2.MsgGrantAllowance.fromPartial(value) });
                return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo);
            }
            catch (e) {
        ...
        msgGrantAllowance({ value }) {
            try {
                return { typeUrl: "/cosmos.feegrant.v1beta1.MsgGrantAllowance", value: tx_2.MsgGrantAllowance.fromPartial(value) };
            }
            catch (e) {
