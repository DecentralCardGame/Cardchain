...
function createBaseCollectionProposal(): CollectionProposal {
  return { title: "", description: "", collectionId: 0 };
}

export const CollectionProposal = {
  encode(message: CollectionProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CollectionProposal {
  ...
  fromPartial<I extends Exact<DeepPartial<CollectionProposal>, I>>(object: I): CollectionProposal {
    const message = createBaseCollectionProposal();
