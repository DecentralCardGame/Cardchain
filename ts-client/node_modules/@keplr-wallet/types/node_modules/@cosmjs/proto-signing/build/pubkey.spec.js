...
describe("pubkey", () => {
    ...
    const defaultPubkeyBytes = encoding_1.fromBase64(defaultPubkeyBase64);
    ...
    describe("encodePubkey", () => {
        it("works for secp256k1", () => {
            ...
            expect(pubkey_1.encodePubkey(pubkey)).toEqual(any_1.Any.fromPartial({
        ...
        it("throws for unsupported pubkey types", () => {
            ...
            expect(() => pubkey_1.encodePubkey(pubkey)).toThrowError(/not recognized/i);
        });
    });
    describe("decodePubkey", () => {
        it("works for secp256k1", () => {
            ...
            expect(pubkey_1.decodePubkey(pubkey)).toEqual({
        ...
        it("throws for unsupported pubkey types", () => {
            ...
            expect(() => pubkey_1.decodePubkey(pubkey)).toThrowError(/not recognized/i);
        });
    });
});
