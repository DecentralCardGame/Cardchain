...
const (
	Msg_UpdateParams_FullMethodName = "/cardchain.featureflag.Msg/UpdateParams"
	Msg_Set_FullMethodName          = "/cardchain.featureflag.Msg/Set"
)
...
func (c *msgClient) Set(ctx context.Context, in *MsgSet, opts ...grpc.CallOption) (*MsgSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_Set_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) Set(context.Context, *MsgSet) (*MsgSetResponse, error) {
...
func _Msg_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_Set_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
