...
var (
	md_OutpSet         protoreflect.MessageDescriptor
	fd_OutpSet_set     protoreflect.FieldDescriptor
	fd_OutpSet_artwork protoreflect.FieldDescriptor
)

func init() {
	file_cardchain_cardchain_set_proto_init()
	md_OutpSet = File_cardchain_cardchain_set_proto.Messages().ByName("OutpSet")
	fd_OutpSet_set = md_OutpSet.Fields().ByName("set")
	fd_OutpSet_artwork = md_OutpSet.Fields().ByName("artwork")
}

var _ protoreflect.Message = (*fastReflection_OutpSet)(nil)

type fastReflection_OutpSet OutpSet

func (x *OutpSet) ProtoReflect() protoreflect.Message {
	return (*fastReflection_OutpSet)(x)
}

func (x *OutpSet) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_OutpSet_messageType fastReflection_OutpSet_messageType
var _ protoreflect.MessageType = fastReflection_OutpSet_messageType{}

type fastReflection_OutpSet_messageType struct{}

func (x fastReflection_OutpSet_messageType) Zero() protoreflect.Message {
	return (*fastReflection_OutpSet)(nil)
}
func (x fastReflection_OutpSet_messageType) New() protoreflect.Message {
	return new(fastReflection_OutpSet)
}
func (x fastReflection_OutpSet_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_OutpSet
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_OutpSet) Descriptor() protoreflect.MessageDescriptor {
	return md_OutpSet
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_OutpSet) Type() protoreflect.MessageType {
	return _fastReflection_OutpSet_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_OutpSet) New() protoreflect.Message {
	return new(fastReflection_OutpSet)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_OutpSet) Interface() protoreflect.ProtoMessage {
	return (*OutpSet)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_OutpSet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Set_ != nil {
		value := protoreflect.ValueOfMessage(x.Set_.ProtoReflect())
		if !f(fd_OutpSet_set, value) {
			return
		}
	}
	if len(x.Artwork) != 0 {
		value := protoreflect.ValueOfBytes(x.Artwork)
		if !f(fd_OutpSet_artwork, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_OutpSet) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		return x.Set_ != nil
	case "cardchain.cardchain.OutpSet.artwork":
		return len(x.Artwork) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cardchain.cardchain.OutpSet"))
		}
		panic(fmt.Errorf("message cardchain.cardchain.OutpSet does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OutpSet) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		x.Set_ = nil
	case "cardchain.cardchain.OutpSet.artwork":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_OutpSet) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		value := x.Set_
	...
	default:
		...
		panic(fmt.Errorf("message cardchain.cardchain.OutpSet does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OutpSet) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		x.Set_ = value.Message().Interface().(*Set)
	case "cardchain.cardchain.OutpSet.artwork":
		x.Artwork = value.Bytes()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cardchain.cardchain.OutpSet"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OutpSet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		if x.Set_ == nil {
			x.Set_ = new(Set)
	...
	case "cardchain.cardchain.OutpSet.artwork":
		panic(fmt.Errorf("field artwork of message cardchain.cardchain.OutpSet is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cardchain.cardchain.OutpSet"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_OutpSet) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cardchain.cardchain.OutpSet.set":
		m := new(Set)
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_OutpSet) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cardchain.cardchain.OutpSet", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_OutpSet) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_OutpSet) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_OutpSet) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_OutpSet) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*OutpSet)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Artwork) > 0 {
			i -= len(x.Artwork)
			copy(dAtA[i:], x.Artwork)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Artwork)))
			i--
			dAtA[i] = 0x12
		}
		if x.Set_ != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: OutpSet: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: OutpSet: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Artwork", wireType)
				}
				var byteLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Artwork = append(x.Artwork[:0], dAtA[iNdEx:postIndex]...)
				if x.Artwork == nil {
					x.Artwork = []byte{}
				}
				iNdEx = postIndex
...
func (x *AddrWithQuantity) slowProtoReflect() protoreflect.Message {
	mi := &file_cardchain_cardchain_set_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
// Enum value maps for CStatus.
var (
	CStatus_name = map[int32]string{
		0: "design",
		1: "finalized",
		2: "active",
		3: "archived",
	}
	CStatus_value = map[string]int32{
		"design":    0,
		"finalized": 1,
		"active":    2,
		"archived":  3,
...
func (CStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_cardchain_cardchain_set_proto_enumTypes[0].Descriptor()
}

func (CStatus) Type() protoreflect.EnumType {
	return &file_cardchain_cardchain_set_proto_enumTypes[0]
}

func (x CStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CStatus.Descriptor instead.
...
type OutpSet struct {
	...
	Set_    *Set   `protobuf:"bytes,1,opt,name=set,proto3" json:"set,omitempty"`
	Artwork []byte `protobuf:"bytes,2,opt,name=artwork,proto3" json:"artwork,omitempty"`
}

func (x *OutpSet) Reset() {
	*x = OutpSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cardchain_cardchain_set_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *OutpSet) GetArtwork() []byte {
	if x != nil {
		return x.Artwork
	}
	return nil
...
func (*AddrWithQuantity) Descriptor() ([]byte, []int) {
	return file_cardchain_cardchain_set_proto_rawDescGZIP(), []int{3}
}
...
var file_cardchain_cardchain_set_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x03, 0x0a, 0x03, 0x53, 0x65, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x72, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x63, 0x61, 0x72, 0x64, 0x63,
	...
	,
...
var file_cardchain_cardchain_set_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cardchain_cardchain_set_proto_goTypes = []interface{}{
	(CStatus)(0),             // 0: cardchain.cardchain.CStatus
	(*Set)(nil),              // 1: cardchain.cardchain.Set
	(*InnerRarities)(nil),    // 2: cardchain.cardchain.InnerRarities
	(*OutpSet)(nil),          // 3: cardchain.cardchain.OutpSet
	(*AddrWithQuantity)(nil), // 4: cardchain.cardchain.AddrWithQuantity
	(*v1beta1.Coin)(nil),     // 5: cosmos.base.v1beta1.Coin
}
var file_cardchain_cardchain_set_proto_depIdxs = []int32{
	0, // 0: cardchain.cardchain.Set.status:type_name -> cardchain.cardchain.CStatus
	4, // 1: cardchain.cardchain.Set.contributorsDistribution:type_name -> cardchain.cardchain.AddrWithQuantity
	2, // 2: cardchain.cardchain.Set.Rarities:type_name -> cardchain.cardchain.InnerRarities
	1, // 3: cardchain.cardchain.OutpSet.set:type_name -> cardchain.cardchain.Set
	5, // 4: cardchain.cardchain.AddrWithQuantity.payment:type_name -> cosmos.base.v1beta1.Coin
...
func file_cardchain_cardchain_set_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cardchain_cardchain_set_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
