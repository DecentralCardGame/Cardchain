...
const (
	...
	opWeightMsgCardBan = "op_weight_msg_ban_card"
	// TODO: Determine the simulation weight value
	defaultWeightMsgCardBan int = 100

	opWeightMsgEarlyAccessGrant = "op_weight_msg_early_access_grant"
	// TODO: Determine the simulation weight value
	defaultWeightMsgEarlyAccessGrant int = 100

	opWeightMsgSetActivate = "op_weight_msg_set_activate"
	// TODO: Determine the simulation weight value
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	simState.AppParams.GetOrGenerate(opWeightMsgEarlyAccessDisinvite, &weightMsgEarlyAccessDisinvite, nil,
		func(_ *rand.Rand) {
			weightMsgEarlyAccessDisinvite = defaultWeightMsgEarlyAccessDisinvite
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgEarlyAccessDisinvite,
		cardchainsimulation.SimulateMsgEarlyAccessDisinvite(am.accountKeeper, am.bankKeeper, am.keeper),
	))

	var weightMsgCardBan int
	simState.AppParams.GetOrGenerate(opWeightMsgCardBan, &weightMsgCardBan, nil,
		func(_ *rand.Rand) {
			weightMsgCardBan = defaultWeightMsgCardBan
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCardBan,
		cardchainsimulation.SimulateMsgCardBan(am.accountKeeper, am.bankKeeper, am.keeper),
	))

	var weightMsgEarlyAccessGrant int
	simState.AppParams.GetOrGenerate(opWeightMsgEarlyAccessGrant, &weightMsgEarlyAccessGrant, nil,
		func(_ *rand.Rand) {
			weightMsgEarlyAccessGrant = defaultWeightMsgEarlyAccessGrant
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgEarlyAccessGrant,
		cardchainsimulation.SimulateMsgEarlyAccessGrant(am.accountKeeper, am.bankKeeper, am.keeper),
	))

	var weightMsgSetActivate int
	simState.AppParams.GetOrGenerate(opWeightMsgSetActivate, &weightMsgSetActivate, nil,
		func(_ *rand.Rand) {
			weightMsgSetActivate = defaultWeightMsgSetActivate
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgSetActivate,
...
func (am AppModule) ProposalMsgs(simState module.SimulationState) []simtypes.WeightedProposalMsg {
	return []simtypes.WeightedProposalMsg{
		...
		simulation.NewWeightedProposalMsg(
			opWeightMsgEarlyAccessDisinvite,
