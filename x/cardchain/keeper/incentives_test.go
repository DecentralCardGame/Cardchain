...
func TestIncentives(t *testing.T) {
  ...
  params := types.DefaultParams()
	...
	k.SetRunningAverage(ctx, keeper.Games24ValueKey, runningAverage)

	require.EqualValues(t, runningAverage, k.GetRunningAverage(ctx, keeper.Games24ValueKey))
  require.EqualValues(t, []*types.RunningAverage{&runningAverage, &clearRunningAverage}, k.GetAllRunningAverages(ctx))
