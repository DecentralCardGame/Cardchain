...
func TestMsgSetNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cardservice/SetName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j","value":"1"}}`
...
func TestMsgBuyNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cardservice/BuyName","value":{"bid":[{"amount":"10","denom":"atom"}],` +
...
func TestMsgDeleteNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cardservice/DeleteName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j"}}`
