...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/ignite/cli/releases/download/v0.26.1/ignite_0.26.1_darwin_amd64.tar.gz"
		FTYPE=".tar.gz
		;;
	"darwin_arm64")
		URL="https://github.com/ignite/cli/releases/download/v0.26.1/ignite_0.26.1_darwin_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/ignite/cli/releases/download/v0.26.1/ignite_0.26.1_linux_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/ignite/cli/releases/download/v0.26.1/ignite_0.26.1_linux_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
