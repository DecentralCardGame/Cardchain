...
func (app *cardServiceApp) GetKey(storeKey string) *sdk.KVStoreKey {
	return app.keys[storeKey]
}

// GetTKey returns the TransientStoreKey for the provided store key
func (app *cardServiceApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *cardServiceApp) Codec() *codec.Codec {
	return app.cdc
}

// SimulationManager implements the SimulationApp interface
func (app *cardServiceApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
