...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		cardchainmoduletypes.UsersStoreKey, cardchainmoduletypes.CardsStoreKey, cardchainmoduletypes.InternalStoreKey,
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		AddRoute(cardchainmoduletypes.RouterKey, cardchainmodule.NewCopyrightProposalHandler(app.CardchainKeeper)).
